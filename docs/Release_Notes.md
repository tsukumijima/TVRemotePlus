  ...
  - **v2.5.0** - 2021/03/30
    - **リリース概要**
      ...
      - **機能追加・不具合修正・iOS/iPadOS 端末での互換性の改善などを多量に含む3ヶ月分の大型アップデートです**
        ...
        - 前バージョンとの差分が 100コミット以上になったのは初めてかも…？ クオリティや安定性の向上に<s>貴重な</s>春休みを2週間以上丸ごと費やしました
          - なんとか今年度中に間に合ってよかった… ようやく肩の荷が下ろせる
    ...
    - **字幕描画用ライブラリを b24.js から [aribb24.js](https://github.com/monyone/aribb24.js) に変更した**
      ...
      - キャプチャ機能の方でも字幕が表示されている場合はそれを含めてキャプチャできるようになっています
        ...
        - これで TVRP でも字幕入りネタ画像の量産が捗るんじゃないでしょうか（しらんけど）
      - 詳細: https://twitter.com/TVRemotePlus/status/1355591344354299906
    - **iPhone / iPad 端末での互換性改善と不具合修正**
      - **丸々4日間昼から早朝まで費やした涙ぐましい努力で iPhone や iPad でもまともに再生できるようになりました、本当に感謝してほしい**
        - iPhone も iPad も使ってないし（端末を家族から借りて検証した）、Safari の最低最悪なバグのせいで散々無駄骨を折られて最ｯｯｯ悪だったので、iPhone / iPad で使ってる人はマジでもれなく334万円[寄付](https://github.com/tsukumijima/TVRemotePlus#%E5%AF%84%E4%BB%98%E3%81%AB%E3%81%A4%E3%81%84%E3%81%A6)してほしい（冗談）
        - 自分が使っていない端末のブラウザのバグとクソ仕様に悪戦苦闘する事ほど苦痛な事はないし、<u>実装としては合っているのに動かない</u>とかがあって心底しんどかった🥺
      - **ファイル再生でエンコード中、Safari のネイティブ HLS プレイヤーで再生時間が最新のセグメントの範囲にシークされてしまう不具合を修正**
        - 以前から挙動は把握していましたが修正できていませんでした
        - 数時間潰した挙げ句結局 currentTime に 0 ではなく 0.000001 を入れればシークしてくれることが分かり唖然…（ふざけんな、死んでくれ）
