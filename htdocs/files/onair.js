  $(function(){
    ...
    setInterval((function status(){
      ...
      console.log('danmaku_request_success: ' + danmaku_request_success)

      if (danmaku_request_success === true) { // 前回のリクエストが完了しているなら

        danmaku_request_success = false; // リクエストを開始した
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            danmaku_request_success = true; // リクエストを完了した
